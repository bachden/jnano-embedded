...
public class inproc_thr {
	static class Worker implements Runnable {
		public Worker(NanoLibrary nano, int message_count, int message_size, String addr, CountDownLatch done) {
			this.nano = nano;
...
//        }
		...
		message_count = (int) 1e6;// Integer.parseInt(args[1]);
		...
		new Thread(new Worker(nano, message_count, message_size, addr, done)).start();
