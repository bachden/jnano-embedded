...
public class Tester {
	...
	private void testOptions() {
		 ...
		 * WARNING
		 *
		 * Use new() for this variable or be a victim of Java's misguided attempts to
		 * cache Integer values. For more information, visit
		 * http://stackoverflow.com/questions/1995113/strangest-language-feature and
		 * search for "Fun with auto boxing and the integer cache in Java"...
		 */
		Integer optval = new Integer(-1);
		int optnew = -1;
		int ret = 0;

		int socket = nano.nn_socket(nano.AF_SP, nano.NN_PAIR);
